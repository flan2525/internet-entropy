...
export const searchWeb = async (query: string, env: RuntimeEnv, options: SearchOptions = {}): Promise<{ items: SearchItem[]; provider: 'brave'; requestedCount: number }> => {
  ...
  return { items, provider: 'brave', requestedCount }
}
