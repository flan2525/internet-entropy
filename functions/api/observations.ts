...
const empty = { hasObservation: false, observedAt: null, score: null, previousScore: null, completedRuns: 0, analyzedPages: 0, startDate: null, nextObservation: '定期観測の設定後に表示', domains: ['医療・健康', '災害・防災', '科学・技術', 'ニュース・時事', '製品レビュー'].map((name) => ({ name, score: null, pages: 0, observedAt: null })) }
